package com.angelo.selenium.udemy.xpath;
...
public class XPathSiblingDemo2 {
    ...
    public static void main(String[] args) {
        ...
        */ 
        String searchSibling = "//*[@id='tablist1-tab1']";            
        searchAndListElements(driver, searchSibling);
        /*
        elements nr : 1
        Appium
        */
        searchSibling = "//*[@id='tablist1-tab1']/following-sibling::li";            
        searchAndListElements(driver, searchSibling);
        /*
        elements nr : 3
        Selenium
        ...
        Testing
        */
        searchSibling = "//*[@id='tablist1-tab1']/following-sibling::li[1]";            
        searchAndListElements(driver, searchSibling);
        /*
        elements nr : 1
        Selenium
        */
        searchSibling = "//*[@id='tablist1-tab1']/following-sibling::h2";            
        searchAndListElements(driver, searchSibling);
        /*
        elements nr : 0
        */
        
        searchSibling = "//*[@id='tablist1-tab2']";            
        searchAndListElements(driver, searchSibling);
        /*
        elements nr : 1
        Selenium
        */
        ...
        Testing
        */
        searchSibling = "//*[@id='tablist1-tab2']/following-sibling::li[2]";            
        searchAndListElements(driver, searchSibling);
        /*
        elements nr : 1
        Testing
